  ...
  return (
    <>
      <button
        ...
        className={
          className ??
          "inline-flex size-11 items-center justify-center rounded-full border border-line bg-white/80 text-slate-900 transition hover:bg-white"
        }
      >
      ...
      {open && typeof document !== "undefined"
        ? createPortal(
            <div className="fixed inset-0 z-[70] bg-slate-950/45 p-4">
              <div className="mx-auto flex h-full w-full max-w-md flex-col overflow-hidden rounded-[28px] bg-[#f8f4ea] shadow-2xl">
                <div className="flex items-center justify-between gap-3 border-b border-line px-5 py-4">
                  <div>
                    <p className="text-sm uppercase tracking-[0.18em] text-slate-500">Menu</p>
